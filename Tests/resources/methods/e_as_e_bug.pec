...
define printName as: method receiving: Person e doing:
	print with "/person=" + e.name as value

define printName as: method receiving: Company e doing:
	print with "/company=" + e.name as value
